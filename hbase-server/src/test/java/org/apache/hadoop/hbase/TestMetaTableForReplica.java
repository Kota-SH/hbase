...
//    metaTableName = MetaTableName.class.getDeclaredField("META_TABLE_NAME");
...
//    String metaTableName = MetaTableName.getInstance().getNameWithNamespaceInclAsString();
//    assertNotNull(metaTableName);
//
//    // Check if name of the meta table for replica is same as the default meta table
//    assertEquals(0,
//      MetaTableName.getInstance().compareTo(TableName.getDefaultNameOfMetaForReplica()));
//  }
//
...
//
//    TableName currentMetaName = MetaTableName.getInstance();
